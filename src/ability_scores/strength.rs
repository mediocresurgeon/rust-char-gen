...
impl Strength {
    fn new(base_score: Option<u8>) -> Strength {
        Strength {
...
impl ability_scores::AbilityScore for Strength {
    ...
    fn set_base(&mut self, base_score: Option<u8>) -> &mut Strength {
        self.score.set_base(base_score);
        return self;
    }

    fn add_penalty(&mut self, penalty: u8) -> &mut Strength {
        self.score.add_penalty(penalty);
        return self;
    }

    fn remove_penalty(&mut self, penalty: u8) -> &mut Strength {
    ...
    fn add_enhancement(&mut self, bonus: u8) -> &mut Strength {
        self.score.add_enhancement(bonus);
        return self;
    }

    fn remove_enhancement(&mut self, bonus: u8) -> &mut Strength {
    ...
    fn add_inherent(&mut self, bonus: u8) -> &mut Strength {
        self.score.add_inherent(bonus);
        return self;
    }

    fn remove_inherent(&mut self, bonus: u8) -> &mut Strength {
    ...
    fn add_untyped(&mut self, bonus: u8) -> &mut Strength {
        self.score.add_untyped(bonus);
        return self;
    }

    fn remove_untyped(&mut self, bonus: u8) -> &mut Strength {
