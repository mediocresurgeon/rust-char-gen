...
impl Charisma {
    fn new(base_score: Option<u8>) -> Charisma {
        Charisma {
...
impl ability_scores::AbilityScore for Charisma {
    ...
    fn set_base(&mut self, base_score: Option<u8>) -> &mut Charisma {
        self.score.set_base(base_score);
        return self;
    }

    fn add_penalty(&mut self, penalty: u8) -> &mut Charisma {
        self.score.add_penalty(penalty);
        return self;
    }

    fn remove_penalty(&mut self, penalty: u8) -> &mut Charisma {
    ...
    fn add_enhancement(&mut self, bonus: u8) -> &mut Charisma {
        self.score.add_enhancement(bonus);
        return self;
    }

    fn remove_enhancement(&mut self, bonus: u8) -> &mut Charisma {
    ...
    fn add_inherent(&mut self, bonus: u8) -> &mut Charisma {
        self.score.add_inherent(bonus);
        return self;
    }

    fn remove_inherent(&mut self, bonus: u8) -> &mut Charisma {
    ...
    fn add_untyped(&mut self, bonus: u8) -> &mut Charisma {
        self.score.add_untyped(bonus);
        return self;
    }

    fn remove_untyped(&mut self, bonus: u8) -> &mut Charisma {
